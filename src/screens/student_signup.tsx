  ...
  return <Center w="100%">
      <Box safeArea p="2" w="90%" maxW="290" py="8">
        ...
        <FormControl>
            ...
            <FormControl.HelperText>{validateString(firstName) ? "" : "Please enter your first name"}</FormControl.HelperText>
          </FormControl>
          <FormControl>
            <FormControl.Label>Last name</FormControl.Label>
            <Input value={lastName} onChangeText={setLastName}/>
            <FormControl.HelperText>{validateString(lastName) ? "" : "Please enter your last name"}</FormControl.HelperText>
          </FormControl>
          <FormControl>
            <FormControl.Label>Student ID</FormControl.Label>
            <Input value={canonicalID} onChangeText={setCanonicalID}/>
            <FormControl.HelperText>{validateString(canonicalID) ? "" : "Please enter your Student ID"}</FormControl.HelperText>
          </FormControl>
          <FormControl>
            <FormControl.Label>School</FormControl.Label>
            <Input value={school} onChangeText={setSchool}/>
            <FormControl.HelperText>{validateString(school) ? "" : "Please enter the name of your school"}</FormControl.HelperText>
          </FormControl>
          <Button mt="2" onPress={() => request.refetch()} disabled={!canContinueStudent(firstName, lastName, canonicalID, school)}>
           Sign up
          </Button>
