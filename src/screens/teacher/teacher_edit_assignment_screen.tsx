...
const EditAssignmentsScreen = ({ navigation }: AssignmentsScreenProps) => {
  ...
  let title = pastTitle;
  let subject = pastSubject;
  let description = pastDescription;
  let points = pastPoints;
  let timeEstimate = pastTimeEstimate;
  let dueDate = pastDueDate;
